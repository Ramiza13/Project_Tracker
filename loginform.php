   ...
   <nav class="navbar navbar-expand-sm navbar-dark bg-teal fixed-top">
        <div class="container">
            <a href="index.html" class="navbar-brand">
                <i class="fa fa-plane-departure"></i> Company Management</a>
        ...
        <div class="container">
            <div class="row">
                ...
                <?php 
                    ...
                    $conn = oci_connect("training1","training1", "localhost/XE");
                    if (!$conn) {
                    	$e = oci_error();
                    ...
                    if(isset($_POST['submit'])){
                      $user = $_POST['usernid'];
                      $pass = $_POST['password'];
                      $s = oci_parse($conn, "select emp_email,emp_password from employee where emp_email='$user' and emp_password='$pass'");       
                      oci_execute($s);
